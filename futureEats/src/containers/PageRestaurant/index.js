...
export class PageRestaurant extends React.Component {
  ...
  filteredMainMenu = () => {
    ...
    if (restaurant.products) {
      mainProducts = restaurant.products.filter((product) => {
        return (
  ...
  filteredSideDish = () => {
    ...
    if (restaurant.products) {
      sideDish = restaurant.products.filter((product) => {
        return product.category.toLowerCase() === "acompanhamento";
      });
    }
    return sideDish;
  };
  ...
  filteredBeverage = () => {
    ...
    if (restaurant.products) {
      beverage = restaurant.products.filter((product) => {
        return product.category.toLowerCase() === "bebida";
      });
    }
    return beverage;
  };
  ...
  renderMainMenu = () => {
    return this.filteredMainMenu().map((product) => (
      <OrderCard
        key={product.id}
  ...
  renderSideDish = () => {
    return this.filteredSideDish().map((product) => (
      <OrderCard
        key={product.id}
        photoUrl={product.photoUrl}
        name={product.name}
  ...
  renderBeverage = () => {
    return this.filteredBeverage().map((product) => (
      <OrderCard
        key={product.id}
        photoUrl={product.photoUrl}
        name={product.name}
    ...
    return (
      <RestaurantPageWrapper>
        ...
        <RestaurantInformation>
          ...
          <Details>
            <Delivery>{restaurant.deliveryTime} min</Delivery>
            <Delivery>Frete R${restaurant.shipping}</Delivery>
          </Details>
