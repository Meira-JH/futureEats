...
export class PageProfile extends React.Component {
  ...
  renderOrdersHistory = () => {
    ...
    return ordersHistory.map((order) => {
      return (
        <HistPedidosCard>
          <PedidoPlaceText>{order.restaurantName}</PedidoPlaceText>
          <PedidoDateText>23 outubro 2019</PedidoDateText>
  ...
  render() {
    ...
    return (
      <ProfileWrapper>
        ...
        <ProfileAdressInfoWrapper>
          <ProfileAdressInfo>
            <ProfileTextSecond>Endereço Cadastrado</ProfileTextSecond>
            <ProfileText>{user.address}</ProfileText>
          </ProfileAdressInfo>
          <EditIcon onClick={this.handleClick2}>
        ...
        <HistPedidosWrapper>{this.renderOrdersHistory()}</HistPedidosWrapper>
